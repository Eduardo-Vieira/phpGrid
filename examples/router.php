...
if ($_REQUEST['identifier'] == 'xhrPesquisar') {
    ...
    Grid::create([
        ...
        'columns' => [
            ...
            'USUARIO.CS_SITUACAO' => [
                'searchField' => '<select name="USUARIO.CS_SITUACAO:ANY"><option value="1">ATIVADO</option><option value="2">DESATIVADO</option></select>',
                'value' => [
                    1 => [
                        'attributes' => [
                            'style' => 'color:blue;'
...
if ($_REQUEST['identifier'] == 'xhrPesquisar2') {
